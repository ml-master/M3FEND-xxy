...
# parser.add_argument('--model_name', default='bigru')
# parser.add_argument('--model_name', default='textcnn')
# parser.add_argument('--model_name', default='bert')
# parser.add_argument('--model_name', default='stylelstm')
parser.add_argument('--model_name', default='dualemotion')
# parser.add_argument('--model_name', default='eann')
# parser.add_argument('--model_name', default='mmoe')
# parser.add_argument('--model_name', default='mose')
# parser.add_argument('--model_name', default='eddfn')
...
if args.dataset == 'en':
    root_path = '../en-v3-1-00/replaceed_en/'
    category_dict = {
        "gossipcop": 0,
        "politifact": 1,
        "COVID": 2,
