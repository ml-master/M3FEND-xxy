...
def word2input(texts, max_len, dataset):
    if dataset == 'ch':
        ...
        tokenizer = BertTokenizer.from_pretrained('/home/xuexinyi/PYPS/M3FEND-main/chinese_wwm_ext_pytorch/')

    elif dataset == 'en':
        # tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        tokenizer = RobertaTokenizer.from_pretrained('/home/xuexinyi/PYPS/M3FEND-main/roberta_base/')
...
class bert_data():
    ...
    def load_data(self, path, shuffle):
        ...
        comments_token_ids, comments_masks = word2input(comments, self.max_len, self.dataset)  # 改成了comment
